...
class Solution {
    ...
    function findDifference($nums1, $nums2) {
        $diff1 = array_unique(array_diff($nums1, $nums2));
        $diff2 = array_unique(array_diff($nums2, $nums1));
...
See on leetcode.com: https://leetcode.com/problems/find-the-difference-of-two-arrays/description
